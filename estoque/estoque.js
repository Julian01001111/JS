...
var CODPROD=1,QTDMIN=15,QTDMAX=50,QTDEST,QTDCCOMPRAR=QTDMAX-QTDEST,COMPRAR;
...
function estoque(){
    ...
    if (COMPRAR==1) console.log('O codigo do produto é' ,CODPROD ,'e a quantiade a comprar é:' ,QTDCCOMPRAR)
